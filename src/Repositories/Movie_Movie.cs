...
namespace WPAppStudio.Repositories
{
    ...
    public class Movie_Movie : IMovie_Movie 
    {
		...
		private const string YoutubeQuery = @"OnePieceUjer";
        ...
        /// <summary>
        /// Retrieves the data from Youtube (channel: OnePieceUjer ), in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        /// <summary>
        /// Refresh the data from Youtube (channel: OnePieceUjer ), in an observable collection of YouTubeVideo items.
        /// </summary>
        /// <returns>An observable collection of YouTubeVideo items.</returns>
		...
		/// <summary>
        /// Retrieves the data from Youtube (channel: OnePieceUjer ), filtered by a filter specification, in an observable collection of YouTubeVideo items.
        /// </summary>
